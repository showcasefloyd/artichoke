...
1) Make Issue Grid a Modal, that uses can up or close. It's too much right now in the Catalog
2) Design Grid so it's easy to read. Each box should be a bit smaller and the grid cell rows and columns evenly spaced out
2) Idea: Show percents of how much for a series has been collected
